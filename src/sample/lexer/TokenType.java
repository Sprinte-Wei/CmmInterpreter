...
public enum TokenType {
    /* 算术运算符 + - * / ++ -- */
    PLUS, MINUS, MULTIPLY, DIVIDE, AUTO_INCREMENT, AUTO_DECREMENT,
    /* 逻辑运算符 > < == != >= <= */
    GREATER_THAN, LESS_THAN, EQUAL, NOT_EQUAL, GREAT_THAN_OR_EQUAL, LESS_THAN_OR_EQUAL,
    /* 赋值运算符 = */
    ASSIGN,
    ...
    NUMBER_INT, NUMBER_DOUBLE, CHARACTER, TRUE, FALSE, STRING,
